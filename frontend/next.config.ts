...
// La Content-Security-Policy elle-même est posée par proxy.ts (nonce différent à chaque
// requête pour script-src), pas ici : next.config ne peut générer qu'une valeur d'en-tête
// statique, incompatible avec un nonce par requête.
